    ...
    <div className="min-h-screen bg-[#050505] text-gray-100 overflow-x-hidden selection:bg-[#D4A324]/30 font-sans">
      ...
      <main className="relative z-10 flex flex-col items-center pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div className="w-full max-w-[675px] mb-12 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <VideoEmbed videoId="692498e6e478a90f43b08572" aspectRatio="aspect-[5/4]" className="border-[#D4A324]/30" />
        </div>
        ...
        {/* Letter / Copy Section */}
        <div className="mt-16 prose prose-invert prose-lg max-w-3xl text-gray-300 leading-relaxed font-light">
        ...
        {/* Pricing Section */}
        <div className="mt-20 w-full max-w-2xl bg-gradient-to-b from-zinc-900 to-black border border-[#D4A324]/30 rounded-2xl p-8 sm:p-12 text-center relative overflow-hidden group">
        ...
        <footer className="mt-24 text-center border-t border-gray-900/50 pt-8 w-full max-w-4xl pb-8 opacity-60">
